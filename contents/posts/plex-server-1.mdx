...
现有大部分教导docker搭建plex的都是基于X86架构的，如果你根据[plexinc/pms-docker](https://hub.docker.com/r/plexinc/pms-docker/)的docker镜像搭建的话，会在docker容器日志中报错：`stderr: exec /init: exec format error`
